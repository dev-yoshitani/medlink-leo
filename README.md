...
A Python engineering simulator for medical-data delivery over intermittent LEO satellite links.
...
MedLink-LEO is available under the [MIT License](LICENSE). See the license file for the copyright notice.
